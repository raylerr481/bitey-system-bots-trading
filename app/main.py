...
app.include_router(auth_router); app.include_router(trading_router); app.include_router(alpaca_router); app.include_router(mt5_router); app.include_router(market_router); app.include_router(market_intelligence_router); app.include_router(strategy_router); app.include_router(quant_router); app.include_router(backtest_router); app.include_router(bot_builder_router); app.include_router(hypothesis_router); app.include_router(news_router); app.include_router(demo_router); app.include_router(bot_profiles_router); app.include_router(bot_exchange_router); app.include_router(integrations_router); app.include_router(validation_router); app.include_router(capabilities_router)
